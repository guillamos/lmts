...
public class TripGenerator
{
	...
	public void PhysicsProcess(int tickRate, uint currentPhysicsTick)
	{
		...
		foreach (var originBuilding in _buildingCollectionStore.Items.Values)
		{
			...
			var originClosestPathLane =
				originPathConnectingPoint.Type == PathInteractionPointType.SideLeft
			...
			var destinationClosestPathLane =
				destinationPathConnectingPoint.Type == PathInteractionPointType.SideLeft
